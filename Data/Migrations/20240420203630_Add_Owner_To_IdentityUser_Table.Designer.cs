...
namespace GameZone.Data.Migrations
{
    ...
    [Migration("20240420203630_Add_Owner_To_IdentityUser_Table")]
    partial class Add_Owner_To_IdentityUser_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameZone.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("ProilePicture")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GameZone.Models.AppUser", b =>
                {
                    b.HasOne("GameZone.Models.Rest", "Rest")
                        .WithOne("Owner")
                        .HasForeignKey("GameZone.Models.AppUser", "RestId");
