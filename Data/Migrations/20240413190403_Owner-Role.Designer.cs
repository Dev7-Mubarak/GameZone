...
namespace GameZone.Data.Migrations
{
    ...
    [Migration("20240413190403_Owner-Role")]
    partial class OwnerRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameZone.Models.RestOwner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c2f65dbc-8d03-4c93-aa6e-6e1e8a249d6b",
                            ConcurrencyStamp = "554f6b9a-8da2-4e1c-ba57-7b3b53368210",
                            Name = "Owner",
            ...
            modelBuilder.Entity("GameZone.Models.RestOwner", b =>
                {
                    b.HasOne("GameZone.Models.Rest", "Rest")
                        .WithOne("RestOwner")
                        .HasForeignKey("GameZone.Models.RestOwner", "RestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
