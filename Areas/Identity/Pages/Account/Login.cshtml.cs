...
namespace GameZone.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [Display(Name = "Emial or User Name")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var s = User.Identity.AuthenticationType;
                    if(await _userManager.IsInRoleAsync(user, Rols.rolAdmin))
                    {
                        _logger.LogInformation("Admin logged in.");
                        return RedirectToAction("Index", "Rests", new { Area = "Admin" });
                    }
                    else if(await _userManager.IsInRoleAsync(user, Rols.rolOwner))
                    {
